...
<div class="container mt-4">
    ...
    <form method="POST" action="/lab/used-services/create" enctype="multipart/form-data" class="card p-4 mt-3 shadow-sm">
        <div class="mb-3">
        ...
        <div class="text-end">
            ...
            <a href="/lab/staff#used-panel" class="btn btn-secondary">Cancel</a>
        </div>
    </form>
</div>
